    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200"></div> */}
          ...
          {/* 5th block */}
          <div className="">
            <h6 className="text-gray-800 font-medium mb-2">Join us</h6>
            <p className="text-sm text-gray-600 mb-4">We will respond when we start the enrollment</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://cruip.com/">White hats</a>. All rights reserved.</div>
